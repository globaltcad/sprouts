 ...
 *  which tells the property that it wants to use the object returned by the {@link #identity()} method
 ...
 *  {@link #identity()} method to a {@link java.util.UUID} field in your view model.
