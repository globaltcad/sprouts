...
public final class PropertyChangeListeners<T>
{
    ...
    public void fireChange( Val<T> owner, Channel channel, ItemChange change ) {
        ValDelegate<T> delegate = Sprouts.factory().delegateOf(Val.ofNullable(owner), channel, change);
