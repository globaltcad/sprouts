...
/**
 *  An event is something that can be triggered and reacted to, through {@link Observable}s
 *  created by the {@link #observable()} method.
 *  It is a form of the observer pattern where an {@link Event} is a source of
 *  events (or notifications) and the {@link Observable}s are the objects where
 *  you register to receive these notifications through your
 *  implementations of the functional {@link Observer} interface.
 *  <p>
