...
Groovy DSL:
```
implementation 'io.github.globaltcad:sprouts:2.4.1'
```
Kotlin DSL:
```
implementation("io.github.globaltcad:sprouts:2.4.1")
...
```
dependencies {
	implementation 'com.github.globaltcad:sprouts:2.4.1'
}
```
...or by using a custom commit hash instead:
```
dependencies {
	implementation 'com.github.globaltcad:sprouts:a92e37d'//Any commit hash...
}
```
---
